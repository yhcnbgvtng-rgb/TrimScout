...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col justify-between selection:bg-emerald-500 selection:text-black">
      ...
      {/* Main Content Grid */}
      <main className="flex-1 mx-auto w-full max-w-6xl px-4 py-8 sm:py-12 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="rounded-3xl border border-border-strong bg-surface p-6 sm:p-8 shadow-2xl space-y-6 relative overflow-hidden backdrop-blur-xl">
            ...
            <div className="rounded-2xl border border-emerald-500/30 bg-emerald-950/20 p-3 flex flex-col sm:flex-row items-center justify-between gap-2.5 text-xs">
              ...
              <button
                ...
                className="w-full sm:w-auto shrink-0 inline-flex items-center justify-center gap-1.5 rounded-xl bg-surface-elevated hover:bg-surface border border-emerald-500/40 px-3 py-1.5 text-xs font-extrabold text-emerald-400 hover:text-emerald-300 transition-all shadow-sm"
              >
