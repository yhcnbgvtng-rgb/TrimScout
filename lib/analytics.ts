...
export const TRACKED_EVENTS = ["factory_build_pending", "factory_build_retry", "factory_build_notify_requested", "vehicle_saved_for_later", "vehicle_resumed", "cta_request_quote_click", "rfq_intent_selected", "dealer_unsubscribed_buyer_notified"] as const;
