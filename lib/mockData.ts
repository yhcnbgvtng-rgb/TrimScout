...
export const MOCK_VEHICLES: Vehicle[] = [
  {
    ...
    packages: ["Sport Chrono Package", "Sport Exhaust System", "BOSE Surround Sound"],
    options: [
      { code: "8LH", name: "Sport Chrono Package", price: 2790, category: "package" },
      { code: "0P9", name: "Sport Exhaust System", price: 2950, category: "package" },
      { code: "9VL", name: "BOSE Surround Sound System", price: 1600, category: "package" },
    ],
    imageUrl: "https://images.unsplash.com/photo-1614162692292-7ac56d7f7f1e?auto=format&fit=crop&w=1200&q=80",
    mileage: 8,
    dealerUrl: "https://www.paulmillerporsche.com/new/Porsche/2026-Porsche-911-parsippany-new-jersey-c8fc378eac183a923e39147dc0005568.htm",
  },
  {
    id: "pm-WP1AA2AY0TDA01307",
    vin: "WP1AA2AY0TDA01307",
    year: 2026,
    make: "Porsche",
    model: "Cayenne",
    trim: "Base",
    ...
    packages: ["Premium Package Plus", "Panoramic Roof System", "Surround View"],
    options: [
      { code: "PF1", name: "Premium Package Plus", price: 6910, category: "package" },
      { code: "KA6", name: "Surround View 3D", price: 1430, category: "package" },
    ],
    imageUrl: "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?auto=format&fit=crop&w=1200&q=80",
    mileage: 11,
    dealerUrl: "https://www.paulmillerporsche.com/new/Porsche/2026-Porsche-Cayenne-parsippany-new-jersey-9b740d40ac1808b693b4732e4f82c1d0.htm",
  },
  {
    id: "pm-WP1AF2A52TLB61802",
    vin: "WP1AF2A52TLB61802",
    year: 2026,
    make: "Porsche",
    model: "Macan",
    trim: "GTS",
    ...
    interiorColor: "GTS Interior in Carmine Red",
    msrp: 113700,
    dealerPrice: 113700,
    daysOnLot: 5,
    status: "on_lot",
    ...
    packages: ["Sport Chrono Package", "Burmester High-End 3D Sound", "18-Way Adaptive Sport Seats"],
    options: [
      { code: "8LH", name: "Sport Chrono Package", price: 2790, category: "package" },
      { code: "9VJ", name: "Burmester High-End 3D Sound", price: 5560, category: "package" },
      { code: "Q1J", name: "18-Way Adaptive Sport Seats", price: 3030, category: "package" },
    ],
    imageUrl: "https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&w=1200&q=80",
    mileage: 9,
    dealerUrl: "https://www.paulmillerporsche.com/new/Porsche/2026-Porsche-Macan-parsippany-new-jersey-297ae3f7ac180fbbb5a0852f4926200e.htm",
  },
  {
