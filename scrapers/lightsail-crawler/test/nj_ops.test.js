...
describe('state registry (src/states.js)', () => {
  it('lists NJ, NY, FL, GA, TX, SC, VA, NC, RI, VT, NH, MA, CA as supported and rejects anything else', () => {
    assert.deepEqual(SUPPORTED_STATES, ['NJ', 'NY', 'FL', 'GA', 'TX', 'SC', 'VA', 'NC', 'RI', 'VT', 'NH', 'MA', 'CA']);
