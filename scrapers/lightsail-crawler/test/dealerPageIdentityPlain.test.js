// Ported from lib/dealerPageIdentity.test.ts (the TS source this file
// mirrors) — same cases, against the plain-JS port used by the crawler's
// nightly bot-report. Keep in sync by hand if either file changes.
import { describe, it } from 'node:test';
import assert from 'node:assert/strict';
import { extractDealerIdentity, isBlockPage, EMPTY_DEALER_IDENTITY } from '../src/dealerPageIdentityPlain.js';
...
describe('extractDealerIdentity — JSON-LD', () => {
  ...
  it('skips malformed JSON-LD instead of failing the whole probe', () => {
    const html =
